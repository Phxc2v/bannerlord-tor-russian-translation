...
**Текущая версия:** `v1.3.15.26` (совместима с TOR_Core v1.3.15)
...
Фикс ванильного бага локализации Bannerlord: модификатор предметов **Cracked** на русском показывался как **«Надломленный? <предмет>»** с лишним вопросительным знаком. Причина — опечатка в нативной строке игры (`std_item_modifiers`, id `br0N6SSH`): TaleWorlds оставил служебный `?` между прилагательным и маркерами склонения (баг был только у этого одного модификатора из 18, затрагивал и нативные, и TOR-предметы). Строка переопределена без `?` — теперь «Надломленный щит» с корректным согласованием по роду. Только XML, DLL без изменений. Подробности — в [CHANGELOG.md](TOR_RU_Translation/CHANGELOG.md).

### v1.3.15.25 (2026-06-12)

Полный аудит DLL и корпуса перевода по репорту «включаю русский — краш» + новый канал перевода тултипов + чистка калек и унификация лор-терминов в названиях отрядов. **46 шаблонных лордов вернули имена** (Псы Войны — Венаторы Воланда, рота Леопарда, Республиканская Гвардия, Пустынные Псы; Избранные Хаоса, капитаны дезертиров, маги-ренегаты, Архилекторы), починен битый токен `{\\?}` в гендер-условии диалога найма, исправлены маркеры склонения в опасных позициях (источник RU-only крашей RussianTextProcessor). **Новый канал перевода TooltipProperty**: тултипы Рыцарства (Мораль/Жалованье рыцарей/Дневное изменение), атрибуты юнита (Здоровье/Защитный оберег/типы урона), панель карты. **+49 переводов**: дипломатия посланников Эонира, Чёрный Грааль, свита охотника на ведьм, некрарх, орочья рубка пленных, friendly fire заклинаний, квест «Сбежавшие детали». **Названия отрядов:** «Рыцарь Львиного Сердца» (было «Львиносердечный»), Irondrake → «Железный дракон», «Лучник с длинным луком», единый орден **Пламенного Солнца** (вычищено 7 разнобойных форм), **Deathjack** → «Жнецы Смерти», **Darksoul** → «Тёмная душа Хаоса», тир `purehearted` → «Чистый сердцем», опечатка «Лионесский». DLL: языковой гейт (при английском языке модуль ничего не подменяет), валидация ink-квестов перед автодеплоем (несовместимый файл больше не может уронить игру после обновления TOR_Core). Подробности — в [CHANGELOG.md](TOR_RU_Translation/CHANGELOG.md).

### v1.3.15.24 (2026-06-02)

Согласование рода и числа у названий магических предметов: префикс редкости больше не даёт «Необычное Топор» — имя строится как «{предмет} ({редкость})». Канон-унификация: прилагательное **громриловый**, **дворф** вместо «дварф», «Дворфийский Карак». Зачистка остаточного английского в меню (убежище, Дуб Веков) и диалоге книги-чародейства (заголовок/тело/кнопки, «Штурмовать убежище»). Рефактор DLL: патчи применяются поштучно — сбой одного больше не отключает остальные переводы. Подробности — в [CHANGELOG.md](TOR_RU_Translation/CHANGELOG.md).

### v1.3.15.23 (2026-05-26)

Глубокая зачистка английского во всех каналах вывода, а не только в XML. Аудит по исходникам TOR_Core вскрыл три «слепых» канала помимо локализуемых XML. Переведено: **1433** реплики диалогов из обновления TOR_Core (орки/гномы), **184** недостающих ключа интерфейса (турнир, карьеры, гильдия гномов, зачарователь, артиллерия, магия, наём), **31** описание книг-предметов, зашитый в код текст (меню пещеры троллей, метки подсказок, уведомления, типы урона/атаки). DLL получила механизмы перевода зашитого текста со словарём и защиту от падений при будущих обновлениях TOR. Подробности — в [CHANGELOG.md](TOR_RU_Translation/CHANGELOG.md).

### v1.3.15.22 (2026-05-21)

**Полный рабочий день — ~370 правок в 14+ файлах.** Семь раундов финального QA по остатку с v1.3.15.21 + три прицельные канон-сверки с исходниками TOR_Core (полный аудит 3 695 troops+items, узкоспециализированная сверка по триплетам id↔EN↔RU из 12 373 пар). Главное — фидбэк игроков на критичную путаницу **Bright Wizard** (Огненный) ↔ **Light Wizard** (Светлый, было «Лёгкий»); расцеплены **Ironbreaker** (Железнобокий) и **Longbeard** (Железнобородый); опечатки богов Хаоса — Тзача→Тзинч, плаанеш→Слаанеш; **Treeman** = Древолюд (не «Древень» — это Толкин!), **Wolf Priest** = Волчий Жрец, **Warrior Priest** = Воин-Жрец, **Stone Slugga** = Гоблин с камнестрелом (НЕ камнемёт). Вычищены неологизмы: Кизот, Племянин, Пизайна, Брасаты, Шамбл, Хорнский, Железобетонный, Древкодерный, Железопроломитель. Vanilla-транслиты → понятный русский (флисса/каскара/адарга/демиланс/тзикурьон/вольгьер/дестиер/вайдрайдер). 18 длинных описаний героев и королевств переписаны абзацами (Брокк, Бардек, Дори, Фургил, Хаминг, Мендри, Эльмадор, Варрик, Борри, Доррин, Финн, Казрик, Бурсбом, Гэрис, Кригер, Арман, Элора, Пьюциус). Catastrophic фикс: settlements/town_GX2 был целиком транслитом EN кириллицей. Имена: Окассен, Рашар, Грунгни, Шато, Альтдорф, Криглиц, Аннфлёр ла Шаритабль, Хергиг, Тан Болли, Гора Серебряного Копья, Перевал Бешеного Пса. Орфография: пшеницы, дворфской, копьё, Малая/Великая Печать, моё терпение.

### v1.3.15.21 (2026-05-19)

Большой проход по корпусу — **~720 точечных правок** в 11 файлах. Каноны WH (Огненный/Аметистовый/Золотой Маги, Защитный оберег, Война Бороды, Пустошь, полурослики, Перевал Серой Леди), ремонт ~110 имён доспехов/оружия (бердыш, капеллина, наручи, моргенштерн, флисса, бишт), 4 шаблона крафта под лимит 50 симв., нормализация кавычек тегированных терминов (~200 замен), переписаны длинные описания Лаурелорна / Хохланда / Жуфбара / Карак-Норна / Brass Keep / Хар-Аклмена / Уррузка. Очистка плейсхолдеров «(позитивный эффект)» из 19 trait-имён. Дави vs Дворф канон-разделение в townspeople. Остаток ~240 длинных нарративных описаний — на v1.3.15.22.

### v1.3.15.20 (2026-05-19)

Аудит-проход — **~45 правок в 6 файлах**. Шаблоны крафта укорочены до ≤21 симв. (баг лимита 50 при заказе у кузнеца). Транслиты типов урона (Фире/Фрост/Магикал/Фисикал/Минор/Ентри) и powerstone-описаний — на русский. `Пустыня`/`'с Y` полу-транслиты в кнопке наёмника и 5 именах клана/поселения. Зачумлённая деревня — диалог культистов Нургла переведён. +13 новых hardcoded/missing строк (диплом-альянсы, AI отрядов в бою, режим колдовства, таверные песни). Все аудит-сканы — 0 находок.
