...
**Текущая версия:** `v1.3.15.16` (совместима с TOR_Core v1.3.15)
...
Расставлены **гендер-маркеры** для системы склонения Bannerlord на ~3 170 предметах и юнитах в 19 файлах (~10 800+ маркеров) — native-модификаторы «Раздробленный/Изящный/Большой колчан {ITEMNAME}» теперь согласуются с русскими именами. Переписаны под живой стиль **описания поселений** Бретоннии, Империи и Эонира. **Bastonne → Бастонь** глобальный канон-каскад. **Сплошной канон-аудит 600+ имён лордов** (~174 правки): «Лоуен Леонкоеур» → «Луэн Леонкёр», «Електор Граф» → «Курфюрст Граф» × 18, латинская диакритика убрана из 18 имён, канон-персонажи (Шварцхельм, Гельт, Хюс, Боэмонд Зверобой), «Даемон Истребитель» → «Демоноборец», дворфьи короли (Иронфорге → Железокузнец и др.). **Правки по in-game фидбэку игрока (32 шт.)**: «Полурыцарь Грифона» → «Рыцарь-Демигриф Грифонов», «Внутренний Круг Рыцарей Грифонов» → «Рыцарь Внутреннего Круга Грифонов», «Чемпион Некроманта» → «Некромант-Чемпион», «Норсканский Конюх» → «Норсканский Конюший», «Отравитель Смертьяка» → «Лучник Жнецов Смерти», «Хаосный Боец Склепа» → «Боец Ямы Хаоса», «Щитовый Унгор» → «Унгор-Щитоносец», «Полугрифон» → «Демигриф» × 5, «Кнутовка для лошади» → «Кнут», «Одинорог» → «Единорог». **Сплошной Хаос-аудит (~50 правок)**: «Хаос Лорд» → «Лорд/Леди Хаоса» × 6, «Хорна» → «Кхорна» × 5, «Сланаешск*» → «Слаанеш*», «Хаосный X» → «X Хаоса» во всех брони/оружии/крафте, «Меч-Греват/Гриваст» → «двуручный топор», «хаосных троллей» → «Троллей Хаоса», «хаосных дворфов» → «Дворфов Хаоса», «Хаос Чемпион» → «Чемпион Хаоса», «Таал'с Чосен» → «Избранники Таала», «Унгрол Фоур-Хорн» → «Унгрол Четырёхрог». Багфиксы: `castle_LL2`, `town_EZ1`, 6 правок Imperial armors, AA_mainhand/AA_offhand задокументированы как баг TOR_Armory (вне scope). **Итого ~256 правок в 13 файлах.**
