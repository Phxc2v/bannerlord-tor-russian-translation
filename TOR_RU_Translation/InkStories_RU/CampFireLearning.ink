...
-> choice1
    ...
    =choice1
        Что вы сделаете? //{MeleeWeaponRandom} {RangedWeaponRandom} //Uncomment for bug testing
            ...
            *[Прикажите своим людям отдохнуть (все спутники исцелены, все раненые войска восстановлены)]
                Вы говорите своим людям ложиться пораньше и отдыхать, сколько смогут.
                ~ HealPartyToFull()
                ->END
...
Пока истории плели свою ткань приключений, солдаты словно переносились в далёкие земли и дикие пустоши. Они размышляли о навыках верховой езды и нерушимой связи между всадником и его конём, что углубило их признательность искусству путешествий верхом.#STR_Traveling3
...
По мере того как рассказы раскрывались, солдаты погружались в искусство выживания, обучаясь читать знаки природы и адаптироваться к её требованиям. Истории подчёркивали навыки медицины, разведки и атлетизма, оставляя солдат с новообретённым уважением к беспощадному, но внушающему трепет миру за пределами безопасности цивилизации. #STR_Survival3
