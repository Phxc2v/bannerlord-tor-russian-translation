...
{IsNight(): Silver moonlight | Golden sunlight } пробивалась сквозь листву деревьев, наполняя поляну теплом. В воздухе витал сладкий аромат расцветающих цветов. Птицы пели свои песни, создавая симфонию, которая казалась бальзамом для вашей уставшей души. #STR_Start3
        ->choice1
        
    =choice1
Что прикажете сделать вашей партии? #STR_Start4
            *[Собрать дикорастущие растения (Несколько попыток {LoreOfLifeInParty: 75% chance (Improved by Lore of Life)| 50% chance} для успешного сбора различных диких растений)] 
