...
They gesture towards the dwelling of the village healer, acknowledging their unwavering dedication in the face of despair, and say, "Seek the healer. They have become our beacon of hope, tirelessly fighting against this unyielding affliction." ->choices 
    ...
    *{met_healer}[Вернись в жилище целителя, надеясь найти его на этот раз.] -> AtTheHealers
...
Amidst the array of medicinal herbs and potions, your gaze lands on something seemingly out of place — a curious vial of dark, viscous liquid that stands apart from the rest. -> choices 
    ...
    =choices
    *[Осмотри странную ампулу. {print_player_skill_chance("Медицина", EASYSKILLCHECK)}]
        {perform_player_skill_check("Medicine", EASYSKILLCHECK): -> succeed | -> fail}
    *[Спроси целителя про ампулу.] -> inquire
    *{found_vial}[Приведи целителя в ярость.] -> ConfrontHealer
    *{found_vial}[Решись сохранить открытие для себя и продолжить расследование.] -> START.choices
    *[Leave.] -> START.choices
...
->choices
    ...
    *{not found_passage}[Откажись от поисков и уйди.] -> START.choices
...
A chilling suspicion takes root in your mind. Could it be that the healer himself is somehow linked to the plague and the cultist rumors? Is there something clandestine hidden beneath the surface of his benevolent facade? With renewed determination you finally decide to Приведи целителя в ярость.
->ConfrontHealer
...
"Wait!" you call out, giving chase as he reaches the back of the dwelling. In a swift motion, he reveals a hidden trap door, flinging it open and disappearing into the depths below. You don't hesitate, following closely behind, descending the narrow steps into the unknown darkness. -> choices
    ...
    =choices
    *[Не колеблясь, ты следуешь за ним, спускаясь по узким ступеням в неизведанную тьму.] -> Descend
