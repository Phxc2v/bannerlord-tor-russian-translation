...
->choices
    ...
    =choices
    + [Узнать о наведении чар.]->Beginning 
    + [Узнать о ингредиентах.]->Ingredients
    + [Узнать о магических предметах.]->MagicItems 
    + [Закрыть книгу] -> END
