...
===Start===
    ...
    =choices
    *[Подойдите к группе и подслушайте их разговор. {print_player_skill_chance("Рогерия", NormalSkillCheckValue)}]
        {perform_player_skill_check("Roguery", NormalSkillCheckValue): ->ListenToGroup.succeed | -> ListenToGroup.fail}
    *[Соберите информацию у жителей, не привлекая внимания.] ->InvestigateVillagers
...
=== InvestigateVillagers ===
    ...
    =choices
    *[Найдите старейшего деревни для допроса.] ->InterviewElder
    *[Выйдите в лес ночью, чтобы выяснить источник странных огней.] ->Woods
    *[Узнайте о исчезновениях, поговорив с родственниками пропавших.] ->InvestigateDisappearances
    * -> OutOfOptions
...
{ElderState == 3: ->grumpy | ->normal}
    ...
    =choices
    *{ElderState == 2}[Сконфронтируйте старейшину, обвинив его в незаконной деятельности из-за его богатства. {print_player_skill_chance("Обаяние", HardSkillCheckValue)}]
    ...
    *[Засадайте на следующего человека, который принесет взятку, чтобы проследить за ним.] -> wait
    *[Найдите другие способы продолжить расследование.] -> InvestigateVillagers.choices
...
===InvestigateDisappearances===
    ...
    =identify_option
    *[Определите символ. {print_player_attribute_chance("Интеллект",5)}] -> identify_check
    ...
    =choices
    *[Тщательно обыщите дома пропавших.] -> search
...
*[Посетите собрание.] -> AttendGathering
*[Откажитесь от поисков. Это расследование уже заняло слишком много вашего времени.] -> VoluntaryEnd
...
*[Осторожно, чтобы не вызвать хаос, попробуйте разоружить культовцев по одному. {print_player_skill_chance("Рогерия", HardSkillCheckValue)}] -> DisarmCultists
*[Раскройте их истинную сущность жителям деревни, заставив тех повернуться против культовцев. {print_player_skill_chance("Обаяние", HardSkillCheckValue)}] -> ExposeCultists
...
{perform_player_skill_check("Charm", HardSkillCheckValue): -> succeed | -> fail}
    ...
    =choices
    *[Преследуйте ближайшего беглеца-культовца.] ->ChaseCultist
...
*[Соберите часть жителей, чтобы организовать оборону под вашим руководством.] -> RallyVillagers
*[Опасаясь за свою жизнь, покиньте это место ужаса и бросьте эту тщетную миссию.]
